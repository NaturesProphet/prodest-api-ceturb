...
let AgenciaController = class AgenciaController {
    ...
    listar() {
        return __awaiter(this, void 0, void 0, function* () {
            return yield this.service.listar_agencias();
        });
    }
};
__decorate([
    common_1.Get(),
    swagger_1.ApiOperation({ title: 'lista as agencias existentes' }),
...
], AgenciaController.prototype, "listar", null);
AgenciaController = __decorate([
    common_1.Controller('agencias'),
    swagger_1.ApiUseTags('Agencias'),
    __metadata("design:paramtypes", [agencia_service_1.AgenciasService])
], AgenciaController);
