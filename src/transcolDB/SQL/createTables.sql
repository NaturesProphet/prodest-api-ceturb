drop table dbo.pontogeografico;
drop table dbo.linha_tarifa_vigencia;
drop table dbo.tarifa;
drop table dbo.vigencia;
drop table dbo.itinerario_ponto;
drop table dbo.feriado;
drop table dbo.estimativa;
drop table dbo.ponto;
drop table dbo.viagem;
drop table dbo.itinerario;
drop table dbo.linha;
...
CREATE UNIQUE INDEX IDX_ae6f96e90d951e9e8c68e3930b ON tempdb.dbo.agencia (url) 
CREATE UNIQUE INDEX IDX_c44350547be6b7a422fdfddc7b ON tempdb.dbo.agencia (nome);
...
CREATE UNIQUE INDEX IDX_44d7ccac6a07ce215335a3ade8 ON tempdb.dbo.contato (nome)
CREATE UNIQUE INDEX IDX_f0323061835775208d577ffabc ON tempdb.dbo.contato (email);
